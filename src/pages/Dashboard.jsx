...
import { FileText, ChevronRight, Activity, AlertCircle, User, Beaker } from 'lucide-react';
        ...
        <section id="dashboard" className="py-10 bg-white dark:bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6">
                        ...
                        <div className="space-y-4 max-h-[600px] overflow-y-auto">
                            {listLoading ? (
                                ...
                                <div className="text-center py-10 text-red-500"><AlertCircle className="h-8 w-8 mx-auto mb-2" /><p>{error}</p></div>
                            ) : reports.length > 0 ? (
                                reports.map((report) => (
                                    <div 
                                        key={report._id} 
