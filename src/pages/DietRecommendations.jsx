        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                    <h2 className="text-xl font-bold text-gray-900 mb-4">Based on Your Health Profile</h2>
                                    ...
                                    <div className="space-y-4">
                                        {dietData.foodRecommendations.recommended.map((item, i) => (
                                            <div key={i} className="bg-white rounded-lg p-4">
                                                <h4 className="font-semibold text-gray-900 mb-1">{item.food}</h4>
                        ...
                        {activeTab === 'meal-plan' && (
                            <div>
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 mb-6">
                                    ...
                                    <p className="text-gray-700 mb-4">{dietData.mealPlans[selectedMealPlan].description}</p>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div className="bg-white rounded-lg p-4">
                                            <h4 className="font-semibold text-gray-900">Daily Calories</h4>
                                        ...
                                        <div className="bg-white rounded-lg p-4">
                                            <h4 className="font-semibold text-gray-900">Meal Count</h4>
                                    ...
                                    {dietData.mealPlans[selectedMealPlan].meals.map((meal, index) => (
                                        <div key={index} className="bg-white rounded-xl shadow-lg p-6">
                                            <div className="flex items-center justify-between mb-4">
                                                <h4 className="text-lg font-bold text-gray-900">{meal.mealType}</h4>
                                            ...
                                            <div className="bg-blue-50 rounded-lg p-3">
                                                <p className="text-sm text-blue-800">💡 {meal.highlight}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {dietData.weeklyMenu.map((day, index) => (
                                            <div key={index} className="bg-white rounded-xl shadow-lg p-6">
                                                ...
                                                <h5 className="font-bold text-gray-700">{day.theme}</h5>
                                                <p className="text-gray-700 text-sm">{day.mealSuggestion}</p>
                                            </div>
                                        ))}
                                    </div>
                                ) : (
